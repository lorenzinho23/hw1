...
<html>
    <head>
        ...
        <script src="../JS/mhw3.js" defer="true"></script>
    ...
    <body>
        ...
        <article>
            <section id="API1">
                ...
                <div id="bottoni">
                    <img src="../foto/aggiorna.png" id ="aggiorna">
        ...
        <div id="principale2">
            <div id="scritta">    
                    ...
                    Puoi effettuare la ricerca dei dati tramite simbolo<br></p>
            </div> 
        </div>
        ...
        <article>        
            <section id="API2">
                <form name='search_content' id='search_content'>
                    ...
                    <label>&nbsp;<input class="submit" type="submit" value="CERCA"></label>
                    <img src="../foto/aggiorna.png" id ="aggiorna2">
                </form>
                
                <!-- MODIFICARE POSIZIONE PULSATE --> 
                ...
                <div class="hidden" id="legenda">
                    ...
                    <ul>
                         ...
                         <li> <strong>Paese:</strong> effettua la ricerca tramite un paese per ottenere l'elenco delle aziende quotate in borsa</li>
